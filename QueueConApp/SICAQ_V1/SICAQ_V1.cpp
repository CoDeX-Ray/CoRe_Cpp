...
void inputDequeueStudent(queue<Student> &studentsQueue)
{
  if (!studentsQueue.empty())
  {
    ...
    {
      outputFile << studentsQueue.front().fullName << ","
                 << studentsQueue.front().ID << ","
                 << studentsQueue.front().department << ","
                 << studentsQueue.front().age << ","
                 << studentsQueue.front().birthday << ","
                 << studentsQueue.front().address << endl;
      studentsQueue.pop();
    }
    outputFile.close();
  }
